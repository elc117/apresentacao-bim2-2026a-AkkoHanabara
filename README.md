...
Nesse código, eu não entendi o que é o "var", que me deixou curioso, pois se usa no App e no 'i', e pelo que eu pude entender, ele esta criando uma variável, mas não entendi qual o tipo dela. ja nos conhecidos, algo que ja havia visto é o app.get, onde ele busca o advice no banco de dado, parecido como era feito no Haskell.
